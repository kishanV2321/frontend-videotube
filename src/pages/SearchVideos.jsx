...
function SearchVideos() {
    ...
    return (
        <>
            ...
            >
                <span className="text-white hover:text-customRed">
                    Filters
                </span>
                <FaFilter
                    size={20}
                    className="text-customRed hover:text-red-500"
                />
            </div>
                    ...
                    <div className="w-full absolute bg-transparent">
                        <div className="max-w-sm border border-slate-800 rounded bg-[#222222] fixed mx-auto z-50 inset-x-0 h-96 p-5">
                            ...
                            <table className="mt-4">
                                ...
                                <tr className="flex flex-col gap-2 text-slate-300 cursor-pointer">
                                    <td
                                        onClick={() =>
                                            handleSortParams(
                                                "createdAt",
