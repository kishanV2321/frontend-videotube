    ...
    return (
        <>
            <div className="w-full h-screen text-white p-3 flex justify-center items-start sm:mt-8">
                <div className="flex flex-col space-y-2 justify-center items-center border border-white p-3">
                    ...
                    >
                        <div className="w-full relative h-28 bg-[#222222]">
                            <div className="w-full h-full">
                                <GetImagePreview
                                    ...
                                    cameraIcon
                                />
                                <div className="text-sm absolute right-2 bottom-2 hover:text-customRed cursor-default">
                                    cover Image
                                </div>
                            </div>
                        ...
                        <Button
                            ...
                            className="w-full sm:py-3 py-2 hover:bg-red-600 text-lg"
                        >
                            Signup
                        </Button>
                        ...
                        <p className="text-center text-sm">
                            ...
                            <Link
                                to={"/login"}
                                className="text-customRed cursor-pointer hover:opacity-70"
                            >
                                Login
                            </Link>
                        </p>
