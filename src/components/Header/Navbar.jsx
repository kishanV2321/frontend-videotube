...
function Navbar() {
    ...
    return (
        <>
            <nav className="w-full bg-[#0E0F0F] flex justify-between items-center p-4 sm:gap-5 gap-2 border-b-2 border-white sticky top-0 z-50">
                ...
                {authStatus ? (
                    ...
                    <div className="space-x-2 sm:block hidden">
                        <Link to={"/login"}>
                            <Button className="bg-[#222222] border hover:bg-black border-white sm:px-4 sm:py-2 p-2">
                                Login
                            </Button>
                        </Link>
                        <Link to={"/signup"}>
                            <Button className="font-semibold border hover:bg-[#222222] border-white sm:px-4 sm:py-2 ">
                                Sign up
                            </Button>
                        </Link>
                    </div>
                        ...
                        <div className="flex flex-col justify-between h-full py-5 px-3 j">
                            <div className="flex flex-col gap-5">
                                {sidePanelItems.map((item) => (
                                    <NavLink
                                        ...
                                        className={({ isActive }) =>
                                            isActive ? "bg-customRed" : ""
                                        }
                                    >
                                        <div className="flex items-center border border-white gap-5 px-3 py-1 hover:bg-customRed">
                                            <div>{item.icon}</div>
                            ...
                            {!authStatus ? (
                                <div className="flex flex-col space-y-5 mb-3">
                                    <Link to={"/login"}>
                                        <Button className="w-full bg-[#222222] border hover:bg-white hover:text-black border-white py-1 px-3">
                                            Login
                                        </Button>
                                    </Link>
                                    <Link to={"/signup"}>
                                        <Button className=" w-full font-semibold border border-white hover:bg-white hover:text-black py-1 px-3">
                                            Sign up
                                        </Button>
                                    </Link>
                                </div>
                                ...
                                <div
                                    className="flex gap-2 justify-start items-start cursor-pointer py-1 px-2 border border-white"
                                    onClick={() => logout()}
                                >
                                    <IoMdLogOut size={25} />
