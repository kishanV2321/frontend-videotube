        ...
        <>
            ...
            >
                <textarea
                    ...
                    className="p-2 text-sm pr-16 focus:border-white text-white border border-white bg-[#222222] outline-none w-full"
                    {...register("content", { required: true })}
                    rows={2}
                />
                <Button
                    type="submit"
                    className="bg-customRed px-2 py-1 text-black hover:scale-110 transition-all ease-in absolute sm:bottom-8 sm:right-8 bottom-8 right-4 text-xs sm:text-base"
                >
                    Send
                </Button>
            </form>
