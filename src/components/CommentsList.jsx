...
function CommentsList({
    ...
    return (
        <>
            <div className="text-white w-full flex justify-start items-center sm:gap-5 gap-3 border-b border-white p-3 sm:p-5">
                <div className="w-12">
                    <img
                        src={avatar || avatar2}
                    ...
                    {authUsername === username && (
                        <div className="absolute right-0">
                            <div className="relative">
                                ...
                                {editState.isOpen && (
                                    <div className="border bg-[#222222] text-lg border-white absolute text-center right-2 rounded-xl">
                                        <ul>
                                            <li
                                                className="hover:opacity-50 px-5 cursor-pointer border-b border-white"
                                                onClick={() =>
                                                    setEditState(
                                                        (prevState) => ({
                                                            ...prevState,
