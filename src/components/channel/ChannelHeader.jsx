            ...
            <div className="w-full text-white">
                ...
                <section className="w-full">
                    {coverImage ? (
                        ...
                        <div className="sm:h-40 h-28 w-full border-white border-b bg-black"></div>
                    )}
                </section>
                ...
                <section className=" w-full sm:px-5 p-2 flex sm:flex-row flex-col items-start sm:gap-4">
                    ...
                    <div className="w-full md:h-24 sm:h-20 flex justify-between items-start px-1">
                        ...
                        {user == userProfile && !edit && (
                            <Link to={"/edit"}>
                                <Button className="border-white hover:scale-110 transition-all text-black font-bold px-4 py-1 bg-customRed">
                                    Edit
                                </Button>
                            </Link>
                        )}
